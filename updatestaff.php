...
if (isset($_POST['submit'])) {
    ...
    $submit = "UPDATE staff SET name='$name', birthday='$birthday', email='$email', address='$address', contact_no='$contact_no'WHERE id='$id'";

    if (mysqli_query($conn, $submit)) {
        echo "<script>alert('Staff member updated successfully!');
